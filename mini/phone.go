...
func (sdk *SDK) MiniCodeGetPhone(ctx context.Context, phoneCode string) (req *WxUserPhone, err error) {
...
func DecryptWeChatOpenDataGetPhone(sessionKey, encryptedData, iv string) (req *WxUserPhone, err error) {
	req = &WxUserPhone{}
	if err = common.DecryptOpenDataToStruct(sessionKey, encryptedData, iv, req); err != nil {
